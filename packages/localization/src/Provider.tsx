...
// languageMap.set(EN.locale, {}) //This line makes website not use translation for English (when you switch from a different language to English)
  ...
  useEffect(() => {
    const fetchInitialLocales = async () => {
      ...
      // if (codeFromStorage !== EN.locale) {
        // this line prevent initial loading of website to use English translation when languageMap.set(EN.locale, {}) is removed
