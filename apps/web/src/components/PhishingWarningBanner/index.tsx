...
const Container = styled(Flex)`
  ...
  linear-gradient(180deg,#728adf 0%,#224186 100%);
...
const domain = 'https://defswap.finance'
...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    ...
    return warningText.split(/(https:\/\/defswap.finance)/g)
  }, [t])
    ...
    <Container className="warning-banner">
      {isMobile || isMd ? (
        ...
        <>
          <InnerContainer>
            <img
              src="/images/decorations/phishing-warning-bunny1.webp"
              alt="phishing-warning"
              width="92px"
              onError={(e) => {
                const fallbackSrc = '/images/decorations/phishing-warning-bunny1.png'
