    ...
    <>
      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xxl" color="secondary" mb="24px" style={{ flexDirection: 'row' }}>
            {t('The')} <span style={{ borderRadius: '25px', background: '#2df3f3', color: 'black', height: '75px', marginLeft: '5px', marginRight: '5px' }}>{t('Future')}</span> {t('is made of DEF.')}
          </Heading>
